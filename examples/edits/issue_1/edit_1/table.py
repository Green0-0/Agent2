    ...
    **kwargs : dict, optional
    ...
    def _set_column_attribute(self, attr, values):
        ...
        for name, value in values.items():
            ...
            if value is not np.ma.masked and value is not None and not isinstance(value, Unit):
                col = self[name]
            ...
            # Handle dimensionless_unscaled unit specifically
            if attr == "unit" and value == u.dimensionless_unscaled:
                setattr(col.info, attr, value)
