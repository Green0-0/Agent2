...
class UnitBase:
    ...
    def __eq__(self, other):
        ...
        if self is dimensionless_unscaled and other is dimensionless_unscaled:
            return True

        try:
            conversion_factor = self._to(other)
        ...
        if isinstance(other, UnitBase):
            ...
            if self_decomposed.powers == other_decomposed.powers and all(
                ...
                if other_decomposed.scale == 0:
                    raise UnitConversionError(f"Cannot convert to unit '{other!r}' with scale zero.")
